...
var ipAPI = []string{
	"http://speedtest.ecnu.edu.cn/getIP.php", "http://www.net.cn/static/customercare/yourip.asp", "http://ddns.oray.com/checkip",
	"http://members.3322.org/dyndns/getip", "http://ns1.dnspod.net:6666", "http://v4.myip.la", "http://haoip.cn",
...
var ip6API = []string{
	"http://speedtest6.ecnu.edu.cn/getIP.php", "http://speed.neu6.edu.cn/getIP.php", "http://v6.myip.la", "http://api-ipv6.ip.sb/ip",
	"http://v6.ipv6-test.com/api/myip.php", "https://v6.ident.me", "http://ip6only.me/api/",
}
